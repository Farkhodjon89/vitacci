      ...
      <div className="container-fluid">
        <div className="row">
                  ...
                  <Link href={'/shop-grid-standard'}>
                    <img
                      src={
                        ...
                        '/assets/images/banner/banner-21.png'
                      }
                      alt=""
                    />
                  </Link>
                ...
                <div className="single-banner mb-20">
                  <Link href={'/shop-grid-standard'}>
                    <img
                      src={
                        process.env.PUBLIC_URL +
                        '/assets/images/banner/banner-22.png'
                      }
                      alt=""
                    />
                  </Link>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="single-banner mb-20">
              <Link href={'/shop-grid-standard'}>
                <img src={'/assets/images/banner/banner-23.png'} alt="" />
              </Link>
                ...
                <div className="single-banner mb-20">
                  <Link href={'/shop-grid-standard'}>
                    <img
                      src={
                        process.env.PUBLIC_URL +
                        '/assets/images/banner/banner-24.png'
                      }
                      alt=""
                    />
                  </Link>
                ...
                <div className="single-banner mb-20">
                  <Link href={'/shop-grid-standard'}>
                    <img
                      src={
                        process.env.PUBLIC_URL +
                        '/assets/images/banner/banner-25.png'
                      }
                      alt=""
                    />
                  </Link>
