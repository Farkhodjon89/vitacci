      ...
      <div className="col-lg-6 col-md-6 col-sm-12">
        <div className="blog-wrap-2 mb-30">
          ...
          <div className="blog-content-2">
            ...
            <h4>
              <Link href={'/blog-details-standard'}>Lorem ipsum blog post</Link>
            </h4>
            <p>
            ...
            <div className="blog-share-comment">
              <div className="blog-btn-2">
                <Link href={'/blog-details-standard'}>read more</Link>
              </div>
      ...
      <div className="col-lg-6 col-md-6 col-sm-12">
        <div className="blog-wrap-2 mb-30">
          ...
          <div className="blog-content-2">
            ...
            <h4>
              <Link href={'/blog-details-standard'}>Ipsum blog post two</Link>
            </h4>
            <p>
              Aenean sollicitudin, lorem quis on endum uctor nisi elitod the
              cona sequat ipsum, necas sagittis sem natoque nibh id penatibus
      ...
      <div className="col-lg-6 col-md-6 col-sm-12">
        <div className="blog-wrap-2 mb-30">
          ...
          <div className="blog-content-2">
            ...
            <h4>
              <Link href={'/blog-details-standard'}>New shop collection</Link>
            </h4>
            <p>
              Aenean sollicitudin, lorem quis on endum uctor nisi elitod the
              cona sequat ipsum, necas sagittis sem natoque nibh id penatibus
      ...
      <div className="col-lg-6 col-md-6 col-sm-12">
        <div className="blog-wrap-2 mb-30">
          ...
          <div className="blog-content-2">
            ...
            <h4>
              <Link href={'/blog-details-standard'}>Lorem blog post four</Link>
            </h4>
            <p>
              Aenean sollicitudin, lorem quis on endum uctor nisi elitod the
              cona sequat ipsum, necas sagittis sem natoque nibh id penatibus
      ...
      <div className="col-lg-6 col-md-6 col-sm-12">
        <div className="blog-wrap-2 mb-30">
          ...
          <div className="blog-content-2">
            ...
            <h4>
              <Link href={'/blog-details-standard'}>Ipsum blog post five</Link>
            </h4>
            <p>
              Aenean sollicitudin, lorem quis on endum uctor nisi elitod the
              cona sequat ipsum, necas sagittis sem natoque nibh id penatibus
