    ...
    <Fragment>
      <div className="blog-details-top">
        <div className="blog-details-img">
          <img alt="" src={'/assets/images/blog/blog-5.jpg'} />
        </div>
      ...
      <div className="tag-share">
        <div className="dec-tag">
          <ul>
            <li>
              <Link href={'/blog-standard'}>lifestyle ,</Link>
            </li>
            <li>
              <Link href={'/blog-standard'}>interior ,</Link>
            </li>
            <li>
              <Link href={'/blog-standard'}>outdoor</Link>
            </li>
          </ul>
        </div>
