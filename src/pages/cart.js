            ...
            <div className="container">
              {cartItems && cartItems.length >= 1 ? (
                <Fragment>
                            ...
                            {(cartItems || []).map((cartItem, key) => {
                              ...
                              return (
                                <tr key={key}>
                                  ...
                                  <td className="product-price-cart" style={{position: "relative"}}>
                                    {cartItem.discount ? (
                                      <Fragment>
                                    ...
                                    <div className='zoodpay-price' style={{justifyContent: "center", color: "#dc3545", fontWeight: "bold", fontSize: "15px", fontFamily: "ArsenalRegular", display: "flex", marginTop: "2px", position: "absolute", width: "100%"}}>{ formatPrice(Math.round(parseInt(cartItem.discount ? finalDiscountedPrice : finalProductPrice) / 4 )) + currency.currencySymbol} / мес.
                                    </div>
                  ...
                  <div className="mt-3">
                    <p>
                      *Бесплатная доставка по Ташкенту осуществляетсяв течении
