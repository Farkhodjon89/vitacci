            ...
            <div className="row px-3 px-sm-0 mb-4">
              <div className="text-block success-text">
                ...
                <p className="mt-2 text-left">
                  ...
                  <br />
                  Если этого не произошло, просьба позвонить по телефону: +99890
                  925 60 00
                  <br />
                  Доставка по Ташкенту – бесплатная при заказе от 1 000 000 сум, осуществляется в течение 48
                  часов с момента заказа.
                  <br />
